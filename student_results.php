...
<div class="row align-items-center mb-4">
    <div class="col-md-8">
        ...
        <p class="text-muted">View your academic performance on completed examinations.</p>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        <th class="px-4 py-3">Course / Exam</th>
                ...
                <tbody>
                    <?php if(empty($results)): ?>
                        <tr><td colspan="4" class="text-center py-5 text-muted">You have not completed any exams yet.</td></tr>
                    <?php else: ?>
                        ...
                        ?>
                            <tr>
                                <td class="px-4">
                                    <strong><?php echo htmlspecialchars($r['course_code']); ?></strong>: <?php echo htmlspecialchars($r['course_title']); ?><br>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="badge bg-warning rounded-pill text-dark px-3"><i class="bi bi-hourglass-split"></i> Awaiting Essay Marking</span>
                                    <?php endif; ?>
                                </td>
